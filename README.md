...
- Multiple API endpoints: configure several mirrors, a random one is picked per request
...
5. **Endpoint selection** — Every request picks one of the configured API endpoints at random
